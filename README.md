...
Trained on proeprty sales data in New York City, the machine learning algorithm will predict the sales price of a property given its age, size, usage, and location using both regression and regularization techniques.
